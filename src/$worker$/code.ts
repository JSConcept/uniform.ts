...
// @ts-ignore
/*@__MANGLE_PROP__*/ import $raw$ from "./index.ts?ts"; /*@__MANGLE_PROP__*/
//const $raw$ = new URL("./index", import.meta.url).href;
const IW = $raw$;
...
const loadCompressed = async (b64c: string): Promise<string|null> => {
    ...
    return URL.createObjectURL(new Blob([b64c], {type: "application/javascript"}));
}
